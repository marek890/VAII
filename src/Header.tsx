...
function Header() {
  return (
    <nav className="fixed top-0 left-0 w-full bg-white/90 border-b border-gray-200 px-10 py-3 shadow-md z-50">
      <div className="flex justify-between items-center w-full">
        ...
        <ul className="hidden md:flex items-center space-x-6 text-lg">
          <li>
            ...
            font-medium decoration-none transition-all duration-200 hover:shadow-md hover:text-[#78E778]"
            >
              Domov
            </a>
          </li>
          ...
          <li>
            <a
              href="#"
              className="navbar-text inline-block px-4 py-2 rounded-lg bg-gray-100 text-gray-500 
            font-medium transition-all duration-200 hover:shadow-md hover:text-[#78E778]"
            >
              Kontakt
            </a>
          </li>
